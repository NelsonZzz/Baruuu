  ...
  try {
      ...
      const sections = [
   {
	...
	rows: [
	    ...
	    {title: `📧 ${pmenus} REPORT`, rowId: ".report", description: `Service bug/eror pada ${namebot}`},
	]
    },{
	...
	rows: [
	    ...
	    {title: `💹 ${pmenus} DONASI`, rowId: ".donasi", description: 'Support BOT agar on 24 jam'},
	]
	},{
	title: `${htki} MENU ${htka}`,
	rows: [
	    {title: `💬 ${pmenus} All`, rowId: ".? all", description: "Menampilkan Semua command FANGZBOT"},
	    {title: `🌱 ${pmenus} Rpg`, rowId: ".? rpg", description: "Game Epic Rpg!"},
	{title: `✨ ${pmenus} Exp`, rowId: ".? xp", description: "Ayo tingkatkan pangkat mu!"},
	{title: `🎮 ${pmenus} Game`, rowId: ".? game", description: "Game yang sangat menarik"},
	{title: `🧩 ${pmenus} Fun`, rowId: ".? fun", description: "Fitur yang aman untuk keluarga"},
	{title: `🐚 ${pmenus} Kerang`, rowId: ".? kerangajaib", description: "Tanyakan pada FANGZBOTZ"},
	...
	{title: `🌎 ${pmenus} Internet`, rowId: ".? internet", description: "Cari sesuatu di FANGZBOTZ"},
	{title: `📩 ${pmenus} Downloaders`, rowId: ".? downloader", description: "Download sesuatu di FANGZBOTZ"},
	{title: `🎨 ${pmenus} Stikers`, rowId: ".? stiker", description: "Buat Sticker di FANGZBOTZ"},
	...
	{title: `🗂️ ${pmenus} Database`, rowId: ".? database", description: "Simpan sesuatu di FANGZBOT"},
	{title: `🛠️ ${pmenus} Tools`, rowId: ".? tools", description: "Mungkin tools ini bisa membantu?"},
	{title: `ℹ️ ${pmenus} Info`, rowId: ".? info", description: "Info info FANGZBOT"},
	{title: `👩‍💻 ${pmenus} Owner`, rowId: ".? owner", description: "Owner Only!"},
	{title: `❓ ${pmenus} Next update`, rowId: ".? nocategory", description: "Fitur Coming soon!"},
	]
  },
]
...
//-------DOC TEMPLATE
            ...
            templateButtons: [
                {
                    urlButton: {
                        displayText: `${namebot}`,
                        url: 'https://wa.me/62895394988123'
                    }
                },
                {
                    urlButton: {
    ...
    //------------------- BUTTON VID
    //conn.sendButton(m.chat, text, wm, 'https://telegra.ph/file/8a59493929725dc89f43b.mp4', [['Ping', '.ping'],['Owner', '.owner'],['Donasi', '.donasi']],ftoko, { gifPlayback: true, contextInfo: { externalAdReply: {title: namebot, body: bottime, sourceUrl: sig, thumbnail: fs.readFileSync('./thumbnail.jpg') }}})
